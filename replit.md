...
-   **Keyword Extraction System**: Implements "Master Visual Synthesizer & Indexer" architecture that combines three information sources:
    ...
    -   Directly generates comprehensive English keywords (`keywordsEn`) without intermediate Chinese translation
    -   Uses dedicated `VOLCENGINE_KEYWORD_API_KEY` endpoint for all keyword extraction operations
